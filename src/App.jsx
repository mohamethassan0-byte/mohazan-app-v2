...
const OWNER_USER = import.meta.env.VITE_OWNER_USER || "Moha";
const OWNER_PASS = import.meta.env.VITE_OWNER_PASS || "mo9090";
const K = {
          ...
          <div style={{ background: TOKENS.paper, borderRadius: 12, padding: 20, width: 290 }}>
            ...
            {profileStep === "form" ? (
              <>
                ...
                <button onClick={() => { setShowProfileForm(false); setProfileStep("form"); }} style={{ width: "100%", background: "none", border: "none", color: TOKENS.inkSoft, padding: "10px 0 0", cursor: "pointer", fontSize: 12 }}>Skip for now — browse as guest</button>
              </>
            ) : (
              <>
                ...
                <button onClick={() => { setShowProfileForm(false); setProfileStep("form"); }} style={{ width: "100%", background: "none", border: "none", color: TOKENS.inkSoft, padding: "2px 0 0", cursor: "pointer", fontSize: 12 }}>Skip for now — browse as guest</button>
              </>
            )}
          </div>
        </div>
